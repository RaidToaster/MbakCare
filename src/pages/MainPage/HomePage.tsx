...
function HomePage () {
    ...
    return (
        <div className="h-full w-screen bg-white">
            <div className="bg-white p-16 flex flex-col md:flex-row justify-center items-center gap-32 ">
                <div className={"flex flex-col gap-8 text-[#492924] md:text-start justify-center md:justify-start text-center w-1/2"}>
                    <h2>WE ARE A</h2>
            ...
            <div className="bg-white p-16 flex md:flex-row flex-col justify-between items-center gap-32">
                ...
                <div className={"flex flex-col gap-16 md:justify-end justify-center w-1/2 md:text-end text-center"}>
