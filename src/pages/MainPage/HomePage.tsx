...
function HomePage () {
    ...
    return (
        <div className="min-h-screen min-w-full h-full w-full cursor-default bg-white">
            <NavigationBar/>
            <div className="bg-white p-8 lg:p-16 flex flex-col lg:flex-row justify-center items-center gap-32 ">
                <div className={"flex flex-col gap-8 text-[#492924] lg:text-start justify-center lg:justify-start text-center w-full lg:w-1/2"}>
                    ...
                    <div className={"flex flex-row justify-center lg:justify-start items-center gap-16"}>
                        <button className={"flex flex-row gap-4 text-[#EFBB4B] font-bold w-48 px-4 py-2 rounded-full justify-center items-center lg:justify-start "} onClick={redirectLogin}>
                            <h3>GET STARTED</h3>
                            <ArrowRight className={"hidden lg:block"}/>
                        </button>
                    </div>
                </div>
                <img src={landingImg} className={"w-80 h-96 lg:w-140 lg:h-120"} alt={"Pictures"}/>
            </div>
            ...
            <div className="bg-white p-16 flex lg:flex-row flex-col justify-between items-center gap-32">
