            ...
            <div className="w-full min-h-screen md:w-3/5 flex flex-col items-center justify-center p-8 gap-16">
                ...
                <div className='flex flex-col items-center justify-center px-12'>
                    ...
                    <div className='flex flex-col items-center justify-center gap-5 mb-6'>
                        ...
                        <Button className="w-full h-12 rounded-3xl bg-gray-800 border border-gray-300 hover:bg-gray-600 cursor-pointer font-medium shadow-sm flex items-center justify-center gap-2 text-white">
